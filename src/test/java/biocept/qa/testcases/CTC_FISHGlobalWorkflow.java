...
public class CTC_FISHGlobalWorkflow extends BioceptBase{
...
//	}
	...
	@Test(priority= 8, dependsOnMethods = { "AccesstionType" },description="Verify user is able to open the Cell Cep Processing Activity")
	...
	public void QAReportingWorklist() throws InterruptedException{
		...
		String ActivityCompleteMessage = workflowCommonMethods.completeMessage();
		ExplicitWait.invisibilityOfLoader();
		myWorklist.visibilityOfSearchTextBox();
		Assert.assertEquals(ActivityCompleteMessage, "QA Reporting has been completed");
	}
	
	
	@Test(priority= 32, dependsOnMethods = { "QAReportingWorklist"},description="Verify user is able to open FISH  Review & Approve Worklist")
	public void FishReviewApproveWorklistTitle() throws InterruptedException{
	...
	@Test(priority= 33, dependsOnMethods = { "FishReviewApproveWorklistTitle"}, description="Verify user is able to Signoff the CTC-FISH Report from FISH Review & Approve Worklist")
	public void FishReportSignoff() throws InterruptedException{
		...
		String ActivityCompleteMessage = workflowCommonMethods.completeMessage();
		ExplicitWait.invisibilityOfLoader();
		fishReviewAndApproveWorklist.visibilityOfSearchTextBox();
...
//	}
	...
	@Test(priority= 34,dependsOnMethods = { "FishReportSignoff"}, description="Verify user is able to open the Completed Worklist")
...
//	}
	...
	@Test(priority= 38, dependsOnMethods = { "ActivityTitleAfterReOpen"}, description="Verify the functionality when user tries to signoff the report again")
